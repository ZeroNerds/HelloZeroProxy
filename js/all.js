  ...
  FeedList = (function(superClass) {
    ...
    FeedList.prototype.reScroll = function(_) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        results.push(obj.onscroll = (function(_this) {
          return function() {
    ...
    FeedList.prototype.checkScroll = function() {
      if (Page.mode !== "Sites" && !this.changed_back) {
        ...
        this.query_limit = 20;
        this.query_day_limit = 3;
        this.changed_back = true;
        this.update();
        return true;
      } else if (document.body.scrollTop + window.innerHeight > document.getElementById("FeedList").clientHeight - 400 && !this.updating && Page.mode === "Sites") {
        this.changed_back = false;
        this.limit += 30;
        this.query_limit += 30;
    ...
    FeedList.prototype.render = function() {
      ...
      setTimeout(this.reScroll, 10, this);
  ...
  ZeroHello = (function(superClass) {
    ...
    ZeroHello.prototype.setProjectorMode = function(mode) {
      ...
      if (mode === "Sites") {
        ...
        setTimeout(this.feed_list.checkScroll.bind(this.feed_list), 10);
        try {
